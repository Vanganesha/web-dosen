  ...
  <div class="container">
    <div class="navbar-header">
      <button class="navbar-toggle" type="button" data-toggle="collapse" data-target=".navbar-collapse">
        ...
        <a href="index.php" class="navbar-brand"><img class="img-rounded" src="gambar/gbr/logo.jpg" style="width: 25px;"><small class="text-center"> Website Dosen Teknik Informatika Universitas Palangkaraya</small></a>
    </div> 
