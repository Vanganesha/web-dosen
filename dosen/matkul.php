...
<html>
    ...
    <h1 class="text-center">Tambahkan Mata Kuliah ke Database</h1>
            ...
            <form class="form-control-static" action="ac-matkul.php?act=tambah" method="post" role="form">
                <div class="form-group">
                    <label for="Mata Kuliah">Nama Mata Kuliah:</label>
                    <input required type="Text" name="matkul" placeholder="Nama Matakuliah" class="form-control">
                    </div>
