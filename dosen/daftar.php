    ...
    <body>
        <div class="container">
            <form class="login" method="post" action="<?php $_SERVER['PHP_SELF'];?>">
                ...
                <input class="form-control" type="text" name="nip" placeholder="Masukkan NIP Anda">
                <label for="password">Jabatan</label>
                <input class="form-control" type="text" name="jabatan" placeholder="e.g Lektor , Tenaga Ahli"><br>
