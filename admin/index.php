...
<html>
    ...
    <?php include 'nav.php'; ?>
         <div class="container">
             ...
             <div class="row" style="background: #fff; box-shadow: 0px 0px 1px 0px;">
          ...
          <?php
            include '../koneksi.php';
            $gdosen=  mysql_query("select nama, nip, username, status,password, iddosen from dosen");
            while ($hgdosen = mysql_fetch_array($gdosen)) {
               ...
               ?>
                        ...
                        <td><?php echo md5(md5(md5($hgdosen[password])));?></td>
                        <td><?php if ($status=='Aktif') {
                        echo 'Aktif';} else {
                        echo 'Tidak Aktif';}  ?> </td>
                        <td class='text-center'><a class="btn btn-primary btn-sm" href="?id=<?php echo $hgdosen['iddosen'];?>&act=st"><?php 
				...
				?>
                                        ...
                                        <a class="btn btn-danger btn-sm" href="javascript:if(confirm('Anda yakin untuk menghapusnya?')) {location.href='logic.php?del_id=<?php echo $hgdosen['iddosen']; ?>&action=del'};" ><span class="glyphicon glyphicon-trash"></span> Hapus</a></td>
                    </tr>
                         <?php } ?>
