    ...
    <body>    
       <?php include 'nav.php'; ?>
        <div class='container' style="padding: 70px 0px;">
          ...
          <?php
            include 'koneksi.php';
            $gdosen=  mysql_query("select iddosen, foto, nama from dosen where status='Aktif' order by nama ASC");
            while ($hgdosen = mysql_fetch_array($gdosen)) {
               ...
               ?>
                <div class='col-xs-6 col-md-3' style="padding-top: 20px;">
                            <div class="picture image-responsive">
                                <a href='dosen.php?id=<?php echo $dosen;?>'><img src='gambar/<?php echo $fto;?>' alt="<?php echo $dosen ?>"  style='height: 250px; width: 100%; display: block;'></a>
