...
<html>
    ...
    <body>    
        <?php include 'nav.php';?>
        <?php $gmat="SELECT a.idmateri AS imat, a.materi AS materi, c.nama AS dosen, a.judul AS judul, b.matkul AS matkul, a.tangglUpload AS tanggal FROM materi a LEFT JOIN matkul b ON a.idmatkul = b.idmatkul LEFT JOIN dosen c ON a.idDosen = c.idDosen where c.status='Aktif' order by a.tangglUpload DESC";
                ...
                <table class="table table-bordered">
                    <thead>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a class="btn btn-default" href="dokumen/download.php?idm=<?php echo $fetmat[imat];?>"><span class="glyphicon glyphicon-download"></span> Download</a></td>
                        </tr>
                        <?php  } ?>
                    </tbody>
